...
let tarifaTotal = consumoKWH > 300 ? (pagoMes + ((20/100)*pagoMes)) : pagoMes;

if (consumoKWH > 300){
    console.log("Debido a que su hogar tuvo un consumo de " + consumoKWH +
    "kwh, en base al ajuste tarifario (hogares con consumo mayor a 300kwh por mes tendrán un aumento del 20%), " +
    "cumplimos con informarle que se ha ajustado el total a pagar, que será de $" + tarifaTotal);
}   else {
        console.log("El total a pagar es $" + tarifaTotal + "ya que no hubo aumentos");
}
